    ...
    if (qrcode.gUM) {
        try {
            ...
            try {
                ...
                console.log("é aqui 1", a);
                setTimeout(qrcode.captureToCanvas, 500)
            }
        } catch (a) {
            console.log("é aqui 2", a);
            setTimeout(qrcode.captureToCanvas, 500)
        }
    }
};
