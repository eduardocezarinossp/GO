	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			marker: {
				latitude: 	-10.918213,
				longitude: 	-55.965549,
				icon: 			'images/pagericon.teste.png',
				title: 			'',
				open: 			false,
				center: 		true
			},
			...
			styles: false,
			locations: [
				[-20.907852, -46.968437, 'img/marker_lageli.png', 'São Sebastião do Paraíso', 
				'<h2>BOJOFORM LTDA</h2><p>Rua Deputado Humberto de Almeida, 700, Pq. Industrial<br />São Sebastião do Paraíso - MG</p><p>Tel.:(35) 3531-7272<br />Tel.:(35) 3531-4737</p>', false, '1']
			]
			// ,origins: [
			// 	['37.936294', '23.947394'],
			// 	['37.975669', '23.733868']
